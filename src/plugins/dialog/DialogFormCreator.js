...
export default class DialogFormCreator {
    ...
    addInput(name, label, attributes = {}, type = 'text') {
        ...
        const div = this.#dom.createElement(TagName.DIV, { attributes: { class: 'form-item' } });
    ...
    #addCancelButton(html, close) {
        const closeButton = this.#dom.createElement(TagName.BUTTON, { attributes: { type: 'button', class: 'cancel' }, html });
    ...
    #addSubmitButton(html) {
        const submitButton = this.#dom.createElement(TagName.BUTTON, {  attributes: { type: 'submit' }, html });
