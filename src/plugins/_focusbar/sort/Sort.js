...
export default class Sort extends Plugin {
    ...
    init() {
        ...
        const sortings = {
            [Sorting.FIRST]: { label: this._('Sort to the beginning'), key: Key.HOME},
            [Sorting.PREV]: { label: this._('Sort before previous element'), key: Key.UP},
            [Sorting.NEXT]: { label: this._('Sort after next element'), key: Key.DOWN},
