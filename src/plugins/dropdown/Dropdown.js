...
export default class Dropdown {
    ...
    */
    #openDropdown(execute, attributes, triggerElement) {
        ...
        const arrow = this.#editor.dom.createElement(TagName.I, { attributes: { class: "arrow", role: "arrow" } });
    ...
    */
    #setArrowIcon(triggerElement, type) {
        const arrowElement = Array.from(triggerElement.children).find((item) => item.className.indexOf("btn-arrow") > -1);
        if (arrowElement) {
