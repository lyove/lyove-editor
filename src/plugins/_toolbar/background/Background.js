...
export default class Background extends Plugin {
    ...
    init() {
        ...
        this.editor.dropdowns.set(new BackgroundDropdown(this.editor));
        this.editor.commands.set(new BackgroundCommand(this.editor, this.constructor.name, TagGroup.BACKGROUND));
    }
}
